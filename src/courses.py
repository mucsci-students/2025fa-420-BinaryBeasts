...
class CourseManager:
    ...
    def get_course_input(self) -> dict:
    ...
    def add_course_interactive(self) -> None:
        ...
        try:
            course_data = self.get_course_input()
    ...
    def modify_course_interactive(self) -> None:
        ...
        self.delete_course(course_id, choice)
        new_course = Course(
    ...
    def delete_course_interactive(self) -> None:
        ...
        if len(course_instances) > 1:
            ...
            if choice == 0:
                ...
                while self.get_course(course_id):
    ...
    def course_management_menu(self, config: dict, config_file: str, time_slots: dict) -> dict:
        """Course management menu interface."""
        self.load_courses(config.get('courses', []))
        ...
        while True:
            ...
            if choice == '1':
                ...
                self.modify_course_interactive()
            elif choice == '4':
